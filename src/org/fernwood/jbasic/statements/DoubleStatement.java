...
/**
 * DOUBLE statement. Declares one or more variables of the given type
 * and assigns values as needed.
 * <p>
 * The syntax of the DOUBLE statement is:
 * <p>
 * <code>
 *       DOUBLE <em>variable</em> [=<em>expression</em>] [, <em>variable</em> [=<em>expression</em>]...]
 * </code>
 * 
 * 
 * @author tom
...
class DoubleStatement extends Statement {

	/**
	 * Compile 'DOUBLE' statement. Processes a token stream, and compiles it into a
	...
	public Status compile(final Tokenizer tokens) {
		...
		return TypeCompiler.compile( session, this, tokens, Value.DOUBLE );
