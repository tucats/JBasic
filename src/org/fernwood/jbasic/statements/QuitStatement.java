...
/**
 * Quit statement. This sets the return object to Status.QUIT which terminates
 * the interpreter.
 * 
 * @author tom
...
class QuitStatement extends Statement {

	/**
	 * Compile 'QUIT' statement. Processes a token stream, and compiles it into
