...
/**
 * DIVIDE statement. Parses an expression and arithmetically multiplies it to the 
 * target value, and stores the value back in the target.
 * <p>
 * The syntax of the DIVIDE statement is
 * <p>
 * <code>
 *
 *            DIVIDE <em>variable</em> BY <em>expression</em> 
 * 
 * </code>
 * <p>
...
class DivideStatement extends Statement {

	/**
	 * Compile 'DIVIDE' statement. Processes a token stream, and compiles it into a
	...
	public Status compile(final Tokenizer tokens) {
		...
		/*
		 * Generate the code to load the current value of the target.
		 */
