...
/**
 * STRING statement. Declares one or more variables of the given type
 * and assigns values as needed.
 * <p>
 * The syntax of the STRING statement is:
 * <p>
 * <code>
 *       STRING <em>variable</em> [=<em>expression</em>] [, <em>variable</em> [=<em>expression</em>]...]
 * </code>
 * 
 * 
 * @author tom
...
class StringStatement extends Statement {
	...
	/**
	 * Compile 'STRING' statement. Processes a token stream, and compiles it into a
	...
	public Status compile(final Tokenizer tokens) {
		 ...
		 * STRING.
		 */
		return TypeCompiler.compile( session, this, tokens, Value.STRING);
