...
/**
 * DECIMAL statement. Declares one or more variables of the given type
 * and assigns values as needed.
 * <p>
 * The syntax of the DECIMAL statement is:
 * <p>
 * <code>
 *       DECIMAL <em>variable</em> [=<em>expression</em>] [, <em>variable</em> [=<em>expression</em>]...]
 * </code>
 * 
 * 
 * @author tom
 * @version version 1.0 Jan 2012
 */

class DecimalStatement extends Statement {

	/**
	 * Compile 'DECIMAL' statement. Processes a token stream, and compiles it into a
	...
	public Status compile(final Tokenizer tokens) {
		...
		return TypeCompiler.compile( session, this, tokens, Value.DECIMAL );
