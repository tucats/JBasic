...
public class RegisterArray {
	...
	/*
	 * The largest register number in the array allocated so far.
	 */
	private int maxRegister;

	/*
	 * An array of Values that represents the register array.
	 */
	private Value register[] = null;

	/*
	 * An array that marks if a given cell in the register array
	 * has been allocated for use by a caller.  When a caller 
	 * allocates space in the register file, this bitmap is used
