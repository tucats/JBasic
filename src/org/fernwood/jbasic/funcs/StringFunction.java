...
/**
 * <b>STRING()</b> JBasic Function
 * <p>
 * <table>
 * <tr><td><b>Description:</b></td><td>Convert to a string.</td></tr>
 * <tr><td><b>Invocation:</b></td><td><code>s = STRING( v )</code></td></tr>
 * <tr><td><b>Returns:</b></td><td>String</td></tr>
 * </table>
 * <p>
 * Converts the argument (regardless of type) to a single string.  This
 * includes numeric, array, and record values.  The string is the same as
 * would be generated by a <code><b>PRINT</b></code> statement.
 * @author cole
 *
 */
public class StringFunction extends JBasicFunction {
	...
	public Status compile(final CompileContext work) throws JBasicException {
		work.validate(1,1);
		work.byteCode.add(ByteCode._CVT, Value.NORMALIZED_STRING);
		return new Status();
	}
