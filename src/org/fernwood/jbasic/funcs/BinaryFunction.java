...
/**
 * <b>BINARY()</b> JBasic Function
 * <p>
 * <table>
 * <tr><td><b>Description:</b></td><td>Convert integer to binary string</td></tr>
 * <tr><td><b>Invocation:</b></td><td><code>s = BINARY( v )</code></td></tr>
 ...
 * @author cole
 */
public class BinaryFunction extends JBasicFunction {
	/**
	...
	public Status compile(final CompileContext work) throws JBasicException {
		work.validate(1,1);
		work.byteCode.add(ByteCode._INTEGER, 2);
