...
/**
 * <b>OCTAL()</b> JBasic Function
 * <p>
 * <table>
 * <tr><td><b>Description:</b></td><td>Convert integer to octal string</td></tr>
 * <tr><td><b>Invocation:</b></td><td><code>s = OCTAL( v )</code></td></tr>
 ...
 * @author cole
 */
public class OctalFunction extends JBasicFunction {
	/**
	...
	public Status compile(final CompileContext work) throws JBasicException {
		work.validate(1,1);
		work.byteCode.add(ByteCode._INTEGER, 8);
